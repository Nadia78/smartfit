...
//3)============= Traitement des erreurs===========================
	...
	if(empty($_POST['genre'])){
		...
		$errors['genre']="la civilitÈ n'est pas renseignÈe";
		echo $errors['genre'];
	}
	//b) Champ prenom et nom : filter var et strlen/ preg match 
	$toto="loulou";
	if(empty($lastname||$firstname)){
		$errors['identity']="Le nom ou le prÈnom n'ont pas ÈtÈ renseignÈ";
		...
		$errors['strenth']="la taille du nom ou du prÈnom n'est pas conforme";
		echo $errors['strenth'];
	}
